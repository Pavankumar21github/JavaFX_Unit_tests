...
public class HomeController implements Initializable {
    ...
    public HomeController() {
        this(HomePageController.getInstance());
    }

    public HomeController(HomePageController homePageController) {
    ...
    @FXML
    public void marutiAction(ActionEvent e) {
        homePageController.createPage(CarsAnchor, "/FXML/Maruti.fxml");
    }

    @FXML
    public void chevroletAction(ActionEvent event) {
        homePageController.createPage(CarsAnchor, "/FXML/Chevrolet.fxml");
    }

    @FXML
    public void hyundaiAction(ActionEvent event) {
        homePageController.createPage(CarsAnchor, "/FXML/Hyundai.fxml");
    }

    @FXML
    public void tataMotorsAction(ActionEvent event) {
        homePageController.createPage(CarsAnchor, "/FXML/TataMotors.fxml");
    }
}
