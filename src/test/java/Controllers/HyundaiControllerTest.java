...
/**
 * Parasoft Jtest UTA: Test class for HyundaiController
 *
 * @see Controllers.HyundaiController
 * @author Pavan
 */
/*public class HyundaiControllerTest {

	/**
	 * Parasoft Jtest UTA: Test for backAction(ActionEvent)
	 *
	 * @see Controllers.HyundaiController#backAction(ActionEvent)
	 * @author Pavan
	 */
/*	@Test(timeout = 5000)
	public void testBackAction() throws Throwable {
		...
		// Given
		HyundaiController underTest = new HyundaiController();
	 ...
	 *
	 * @see Controllers.HyundaiController#initialize(URL, ResourceBundle)
	 * @author Pavan
	 */
/*	@Test(timeout = 5000)
...
public class HyundaiControllerTest {
    ...
    @InjectMocks
    private HyundaiController controller;
